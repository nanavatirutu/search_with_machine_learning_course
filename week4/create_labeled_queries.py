...
def normalize_query(query):
    ...
    query_clean_tokens = [stemmer.stem(token) for token in query_clean_tokens]
...
if file_qn.is_file():
    df = pd.read_csv(output_file_name_normalized)[['category','query']]
else:
    ...
    df.to_csv(output_file_name_normalized, index=False)
